...
## ![](resume_files/figure-html/database-icon.png){width="27" height="27"} Experience
...
## ![](resume_files/figure-html/database-icon.png){width="27" height="27"} Skills
...
## ![](resume_files/figure-html/database-icon.png){width="26" height="27"} Skills Demonstrated
...
ggplot(homeworld_mass, aes(reorder(homeworld, -avg_mass), avg_mass, color = homeworld)) +
  geom_point(aes(size = avg_mass)) +
  geom_segment(aes(x = homeworld, xend = homeworld, y = 0, yend = avg_mass)) +
  labs(title = "Avg of Character Mass by Star Wars Planet") +
  xlab("") +
  ylab("") +
  theme(axis.text.x = element_text(angle = 45, vjust = .5, hjust = 1), 
        legend.position="none") 
...
## ![](resume_files/figure-html/database-icon.png){width="26" height="27"} Formal Education
...
![](resume_files/figure-html/utsa-logo.jpg){width="334"}

## ![](resume_files/figure-html/database-icon.png){width="27" height="28"} Contact
